        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <section className="mb-12 py-8">
              <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-2xl p-12 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl">
                    Discover amazing stories, insights, and knowledge from our community of passionate writers and experts. Join thousands of readers exploring the latest in technology, design, and innovation.
                  </p>
